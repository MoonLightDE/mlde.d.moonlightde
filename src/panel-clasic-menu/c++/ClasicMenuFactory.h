...
#ifndef CLASICMENUFACTORY_H
#define	CLASICMENUFACTORY_H
...
class ClasicMenuFactory : public ILauncherFactory {
public:
    ClasicMenuFactory();
    virtual ~ClasicMenuFactory();
